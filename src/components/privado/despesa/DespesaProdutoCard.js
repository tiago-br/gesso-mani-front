...
class DespesaProdutoCard extends Component {
        ...
        return (
            <Section>
                <Card>
                    ...
                    {this.state.boolean ?<ContainerInput><Input disabled={true} name='valor_de_compra' value ={this.state.valor_de_compra} type = 'number' onChange={this.handleChange}/></ContainerInput> :<h4>{this.state.valor_de_compra}</h4> }
                    ...
                    {this.state.boolean ? <ContainerInput><Input disabled={true} name='valor_de_venda' value ={this.state.valor_de_venda} type = 'number' onChange={this.handleChange}/></ContainerInput> : <h4>{this.state.valor_de_venda}</h4> }
...
export default DespesaProdutoCard
